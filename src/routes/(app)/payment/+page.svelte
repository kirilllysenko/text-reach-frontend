<script lang="ts">
  ...
  import { formatPaymentBalance, type WalletBalanceData } from "$lib/feature/payment/payment-display";
        ...
        <div class="mt-3 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div class="flex flex-col gap-2 sm:flex-row">
            <a
              ...
              href={resolve(PATH_PAYMENT_TOP_UP)}
            ...
            <a
              ...
              href={resolve(PATH_PAYMENT_TRANSACTION)}
