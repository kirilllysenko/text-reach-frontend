<script lang="ts">
  ...
  import type { WalletTransactionsState } from "$lib/features/payments/payments-state.svelte";
  import { walletTransactionSortFieldLabelMap } from "$lib/features/payments/payments-view-data";
